...
// get all products by id Array

export const GetProductsByIdArray = async (array) => {
  try {
    const response = await axiosInstance.post("/api/products/get-products-by-id", array);
    return response.data;
  } catch (error) {
    return error.message;
  }
